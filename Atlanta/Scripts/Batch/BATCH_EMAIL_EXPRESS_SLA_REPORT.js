...
/*------------------------------------------------------------------------------------------------------/
| Program: BATCH_EMAIL_EXPRESS_SLA_REPORT.js  Trigger: Batch
| Client:
|
...
function timeTrackingExpress(fromAddress,toAddress,ccAddress,reportSubject,reportContent,aaReportName)
{
...
//Time Tracking Express Summary
var fromAddress = getParam("fromAddress");                // email from
var toAddress = getParam("toAddress");                    // emails to
var ccAddress = getParam("ccAddress");                    // CC emails to
var reportSubject = 'Time Tracking Express Summary Report for the week of ' + thisMondayFormatted + ' to ' + todayFormatted;
var reportContent = 'Report run from batch script BATCH_EMAIL_EXPRESS_SLA_REPORT';
timeTrackingExpress(fromAddress,toAddress,ccAddress,reportSubject,reportContent,'Time Tracking Express Summary');
