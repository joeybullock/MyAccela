/*------------------------------------------------------------------------------------------------------/
| SVN $Id: InspectionMultipleScheduleBeforeV1.6.js 1051 2007-12-18 17:58:36Z john.schomp $
| Program : InspectionMultipleScheduleBeforeV1.6.js
...
var controlString = "InspectionMultipleScheduleBefore"; 	// Standard choice for control
...
for (thisResult in schedObjArray)
	...
	inspGroup = "" ; // not populated by this event
	inspType = "" ; // not populated by this event
        inspType = aa.inspection.getInspection(capId, curResult.inspId).getOutput().getInspectionType();
