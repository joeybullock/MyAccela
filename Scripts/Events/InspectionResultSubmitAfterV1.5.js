 		...
 		if (TSIResult.getSuccess())
 			...
 			for (a1 in TSI)
  				...
  				if (useTaskSpecificGroupName)
  	  				thisArr[fTask.getProcessCode() + "." + fTask.getTaskDescription() + "." + TSI[a1].getCheckboxDesc()] = 

TSI[a1].getChecklistComment();
  	  			else
...
function getInspectorUser(inspType) 
{ 
var inspResultObj = aa.inspection.getInspections(capId); 
if (inspResultObj.getSuccess()) 
{ 
...
if (String(inspType).equals(inspList[xx].getInspectionType())) 
{ 
return inspList[xx].getInspector() 
} 
} 
return false; 
} 
